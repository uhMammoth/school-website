...
const Home = () => {
  ...
  /*  mobile  */  
  <><img src={home} alt='students chilling with a dog' className='iimage w-full h-40 home shadow-lg'/>
    ...
    <img src={homebottom} alt='students hugging staring at the sun' className=' fixed bottom-0 mb-16 w-full home shadow-lg	h-30'/>
