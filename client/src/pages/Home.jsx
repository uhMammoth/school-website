...
const Home = () => {
  return (
    ...
    <div className="border-2 border-red-800 h-auto w-full bg-amber-100 p-2 mx-auto">
      <div className="my-1 text-lg text-red-800">Please note: Covid-19 restrictions</div>
      <div className="my-1 text-sm text-red-800">Lorem ipsum dolor sit amet consectetur adipisicing elit.sit amesit amet consectetur adipit consectetur adipisic</div>
    </div>
    ...
    <button type="button" className="w-[200px] border-2 border-blue-200 text-white bg-gradient-to-b from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium text-sm py-3 text-center">Know the team.</button>
    <button type="button" className="w-[200px] border-2 border-blue-200 text-white bg-gradient-to-b from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium text-sm text-center">Schedule here.</button>
