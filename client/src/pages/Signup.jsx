...
const Signup = () => {
  return (
    <div>
      ...
      <div class="grid md:grid-cols-2 md:gap-6 flex items-center">
        ...
        <div class="relative z-0 text-center ">
          <Link className='text-md text-gray-800 ml-[122px] mt-8 underline font-semibold'  to='/login'>Log In</Link>
        </div>
      </div>
    </form>
  </div>
      ...
      {/* Mobile */}
    <div className='lg:hidden w-screen h-screen bg-white pt-16'>
      <form className='mx-12'>
      
        <MdCreate className='text-8xl ml-[100px] mb-2 text-blue-800' />
        <div className='text-3xl mb-14 text-gray-800 text-center'>Create Account</div>
