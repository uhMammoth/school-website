...
<div>
    {/* Desktop */}
  <div className='hidden lg:flex justify-center text-left'>
    <form className='my-40'>  
        <IoMdContact className='m-auto text-8xl mb-2 text-blue-800' />
      ...
      <div>
        <div class="text-center">
          ...
          <textarea type="text" id="large-input" class="h-64 p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
        </div>
        <div class="">
